...
class Optimize_Kommo_DB
{
    ...
    public static function create_tables()
    {
        ...
        $sql_leads = "CREATE TABLE {$leads} (
            ...
            time_to_meeting_minutes INT(11) DEFAULT NULL,
            time_to_meeting_hours DECIMAL(10,2) DEFAULT NULL,
            time_to_meeting_days DECIMAL(10,2) DEFAULT NULL,
            time_to_meeting_source VARCHAR(40) DEFAULT 'unavailable',
